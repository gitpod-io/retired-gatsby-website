...
const offers: PricingBoxProps[] = [
  ...
  },
  {
    ...
    features: [
      ...
      <span key="101" className="span">
        4 Parallel Workspaces <PopOver description="The number of workspaces running at the same time." />
      </span>,
      <span key="102" className="span">
  ...
  },
  {
    ...
    price: (
      <>
        <span style={{ textDecoration: 'line-through', opacity: 0.8 }}>{isEurope() ? '€35' : '$39'}</span> {isEurope() ? '€8' : '$9'}
      </>
    ),
    ...
    features: [
      'Private & Public Repos',
      <span key="103" className="span">
        16 Parallel Workspaces <PopOver description="The number of workspaces running at the same time." />
      </span>,
      <span key="104" className="span">
        Team Manageable&nbsp;
        <PopOver description="Setup Gitpod for an entire team with a single invoice and credit card." />
      </span>,
      <span key="105" className="span">
        1h Timeout <PopOver description="Workspaces without user activity are stopped after 30 minutes." />
      </span>
    ]
  }
]
...
const GithubStudentPackPage: React.SFC<{}> = () => (
  <IndexLayout canonical="/github-student-developer-pack/" title="GitHub Student Developer Pack">
    <Banner
      ...
      paragraph={
        <span>
          With Gitpod you have no more tedious setups, you save hours of compiling code, and you can start coding from any device,
          immediately.
        </span>
      }
    ...
    <div className="grey-container">
      <Offers
        ...
        para={
          <p>
            With the{' '}
            <a href="https://education.github.com/pack/?utm_source=github+gitpod" target="_blank" rel="noopener">
              GitHub Student Developer Pack
            </a>
            , you get the same features as with our usual plans but at a much better price.
            <br />
    ...
    <div className="row">
      <Quote title="Stop wasting time with tedious setups, learn amazing programming skills instead!" />
