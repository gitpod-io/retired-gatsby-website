...
export default () => {
    return <BoilerPlate maxHeight={2000} title="Gitpod - Imprint" canonical="https://www.gitpod.io/imprint/">
        <h1>Imprint</h1>
        <p>TypeFox&nbsp;GmbH
        ...
        <h4>Responsible for all content according to
				<b>§ 55 Rundfunkstaatsvertrag (RSTV)</b>:</h4>
        <p>Sven Efftinge,&nbsp;Hofteichstr.7,&nbsp;24113 Kiel</p>
        <h2 >Disclaimer</h2>
        <h2 >Liability for content</h2>
        <p>As a service provider we are responsible according to § 7 paragraph 1 of TMG for own contents on these pages under the
        ...
        <p>Our site contains links to external websites over which we have no control. Therefore we can not accept any responsibility
        ...
        <h2>Copyright</h2>
        <p>The contents and works on these pages created by the site operator are subject to German copyright law. Duplication, processing,
            ...
            will be marked as such. If you still get aware of copyright infringement, we ask for a hint. Upon notification of violations,
				we will remove such content immediately.</p>
        <h2>Settlements of Disputes</h2>
        <p>The European Commission provides a platform for an online settlement of disputes which can be accessed under
