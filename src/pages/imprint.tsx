    ...
    <IndexLayout canonical="/imprint/" title="Imprint">
        <div className="grey-container">
            <TextBox>
                ...
                <p>
                    The European Commission provides a platform for an online settlement of disputes which can be accessed under <a href="http://ec.europa.eu/consumers/odr/" target="_blank">http://ec.europa.eu/consumers/odr/</a>. Gitpod is neither obliged to take part in alternative dispute resolutions before a consumer
