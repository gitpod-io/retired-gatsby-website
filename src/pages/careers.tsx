    ...
    lists: [
      ...
      },
      {
        ...
        items: [
          ...
          'Work remotely from Germany or France, or the office in Kiel (Germany).'
        ]
      }
    ],
    ...
    lists: [
      {
        title: 'What you will do:',
        items: [
          'Design, prototype, and iterate on the UX of new features and refresh existing UX.',
          'Communicate design solutions through wireframes, mockups, and interactive prototypes.',
          'Implement mockups using HTML and TypeScript/JavaScript.',
          'Work closely with engineering and be the "go-to" person when user interface designs require clarification or change.'
        ]
      },
      {
        title: 'What we are looking for:',
        items: [
          '3+ years of experience designing UI / UX and web development (preferably in a B2B SaaS space).',
          'Solid knowledge of developer workflows and tools.',
          'A team player who can also work independently.',
          'A curious mindset with a drive to learn and grow new skills.'
        ]
      },
      {
        title: 'Your benefits:',
...
const Careers = () => (
  <IndexLayout canonical="/careers" title="Careers">
    <StyledCareersPage>
      <div className="row">
        <section className="intro pattern">
          ...
          <a href="#jobs" className="btn btn--cta">
            See Job Openings
          </a>
        </section>
      </div>
      ...
      <section className="pattern-bg">
        <div className="row">
          <div className="team">
            ...
            <div className="text">
              <p>
                Come join a young tech-driven team, with the mission of making software development better for everyone, and strong values
                around openness, honesty, and effective pragmatism.{' '}
              </p>
              <p>We're convinced that continuous learning and exploring is the way to build the best solutions sustainably.</p>
              <p>
                <strong>Help us shape Gitpod’s future from Berlin, Paris, or anywhere in the world!</strong>
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="jobs" id="jobs">
        <div className="row">
          <h2>
            Current <strong>Job Openings</strong>
          </h2>
          <div>
            {jobs.map((job, i) => (
              <ExpandableJob key={i + job.title} {...job} />
            ))}
          </div>
        </div>
          ...
          <div className="row">
            <div className="no-fit">
              <p>
                ...
                please send your application at <a href="mailto:career@typefox.io">career@typefox.io</a> anyway.
              </p>
              <p>
                <strong>We're curious to hear about you.</strong>
              </p>
            </div>
          </div>
        </div>
