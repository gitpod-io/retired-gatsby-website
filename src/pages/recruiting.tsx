...
const RecrutingPage: React.SFC<{}> = () => (
  <IndexLayout canonical="/recruiting/" title="Recruiting">
    ...
    <Quote title="We create the most convenient dev environments." />
    ...
    >
      ...
      <tbody>
        ...
        <tr className="buttons">
          ...
          <td>
            <Link to="/contact/" state={{ subject: 'I have a question regarding Gitpod Recruiting' }} className="btn btn--cta">
              Contact Sales
            </Link>
          </td>
          <td>
    ...
    <ActionCard
      ...
      anchors={[
        ...
        { href: '/contact/', subject: 'I have a question regarding Gitpod Recruiting', text: 'Contact' }
      ]}
    />
  </IndexLayout>
)
