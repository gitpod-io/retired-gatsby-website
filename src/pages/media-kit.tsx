    ...
    <StyledMediaKitPage>
      ...
      <div className="row">
        <div className="resources">
          {resources.map((r, i) => (
            <div className="resource" key={i} style={r.dark ? { background: colors.text } : { background: colors.offWhite }}>
              <div className="resource__img-container">{r.img}</div>
              <div className="resource__text">
                <p>{r.text}</p>
                <a href={r.path} download={`${r.text}.svg`} title={`${r.text}.svg`}>
                  <svg stroke="#9f9f9f" xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23">
                    <g data-name="Gruppe 625">
                      <g
                        data-name="Gruppe 624"
                        transform="translate(1 1) translate(20) rotate(90)"
                        fill="none"
                        stroke-linecap="round"
                        stroke-width="2"
                      >
                        <line data-name="Linie 99" x2="15" transform="translate(0 10)" />
                        <path data-name="Pfad 996" d="M6.472,6.014,0,0" transform="translate(8.528 3.986)" />
                        <path data-name="Pfad 997" d="M6.137,6.139,0,0" transform="translate(8.861 16.271) rotate(-90)" />
                        <line data-name="Linie 118" y2="20" transform="translate(21)" />
                      </g>
                    </g>
                  </svg>
                </a>
