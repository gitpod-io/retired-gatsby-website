...
export default () => {
    return <BoilerPlate title="Gitpod - Privacy Policy">
        ...
        <p>Below we provide you with an overview of what data we collect for what purpose and how we ensure the protection of
				the data <a href="#short">in short</a> and <a href="#detailed">in a more detailed form</a>.</p>
        ...
        <p>The controller is TypeFox GmbH, Am Germaniahafen 1, 24143 Kiel/Germany, registered with the commercial register of
            the local court (Amtsgericht) Kiel under HRB 17385, represented by the managing directors Sven Efftinge, Moritz Eysholdt,
				...
				visitors (the <strong>"User/you/your"</strong>) on our website <a href="/">https://www.gitpod.io</a>
        ...
        <h1 id="short">In Short</h1>

        <table style={{ border: 1, borderStyle: 'solid', borderColor: colors.fontColor2 }}>
            <tr>
        ...
        <h1 id="detailed">More Detailed Information</h1>
        ...
        <ul>
            ...
            <li><a href="#details-V">V. Are my Data transferred to Third Parties? Does automated decision making including profiling take place?</a></li>
            <li><a href="#details-VI">VI. Are my Data transferred outside the EU?</a></li>
            <li><a href="#details-VII">VII. Your Rights</a></li>
            <li><a href="#details-VIII">VIII. Duration of Storing your Data; Data Security; Access and Changes to this Privacy Policy; Contact Details</a></li>
        </ul>
        ...
        <p>
            We use Google Analytics a web analytics tool offered by Google LLC, Mountain View, CA, USA (<strong>"Google"</strong>).
        ...
        <p>
            We point out that an <a href="#details-V">automated decision making or profiling</a> can take place when integrating
        ...
        <h3>Google Fonts</h3>
        <p>
            Our Website uses the <strong>"Google Fonts"</strong> service of Google LLC, Mountain View, CA, USA to integrate and display
        ...
        <h3 id="freshchat">FreshChat</h3>
        <p>
            We use FreshChat by Freshworks Inc., 1250 Bayhill Drive, Suite 315, San Bruno, CA 94066, USA (<strong>"Freshworks"</strong>),
            to enable interaction with you on our Website and/or our Service. As a data processor acting on our behalf, Freshworks
        ...
        <p>
            The legal basis for such data processing is your explicit consent (Art. 6 (1) a. GDPR) and carrying out your request (Art.
            6 (1) b. GDPR). When such data are analyzed as described above this processing is based on our legitimate interests of
            a statistical analysis of the relationship for marketing and quality assurance purposes according to Art. 6 (1) f. GDPR
            or TMG.
			        </p>

        <p>
            More information on FreshChat and Freshworks and their Cookies used may be found here: https://www.freshworks.com/privacy/
            and https://www.freshworks.com/list-of-cookies/
			        </p>
        ...
        <p>
            We do not store or receive any kind of payment or credit card data but use an external payment provider as set forth on the
            Website.
			        </p>

        <p>
            We may also analyze your personal data when using the Gitpod Service for the purpose of improving our Service. The legal
            basis for analyzing such data is Art. 6 (1) f. GDPR with our legitimate interest of marketing and quality assurance.
			        </p>
        ...
        <p>
            When using the Gitpod Service your data may also be processed by third party providers as set forth in this privacy policy,
				...
				as well as <a href="#details-V">V.</a> and <a href="#details-VI">VI.</a> below.
			        </p>
        ...
        <p>
            For more information please refer to <a href="mailto:data@typefox.io">data@typefox.io</a>.
			</p>
        ...
        <p>
            When visiting the Website and using our Service data may be transferred to countries outside the EU whereas the services
				by <a href="#google">Google</a>, <a href="#mailchimp">Mailchimp</a> and <a href="#freshchat">Freshworks</a> are affected.
			</p>
        ...
        <p>
            The US companies providing the services of Google, Mailchimp and Freshworks are each certified under EU-US-Privacy-Shield
            and comply with data protection standards applicable in the EU. For more information on EU-US-Privacy-Shield and details
            about the certificates for Google, Mailchimp and Freshworks please refer to: https://www.privacyshield.gov
			</p>
        ...
        <h2 id="details-VIII">
            VIII. Duration of Storing your Data; Data Security; Access and Changes to this Privacy Policy; Contact Details
			</h2>
