...
const EducationPage: React.SFC<{}> = () => (
  ...
  >
    <Banner
      ...
      title={
        <h1>
          Let’s <strong>Focus on Teaching Code,</strong>
          <br /> not Tedious Setups!
        </h1>
      }
    ...
    <Quote title="We eliminate tedious workflows." />
    ...
    >
      ...
      <tbody>
        ...
        <tr className="buttons">
          ...
          <td>
            <Link to="/contact/" state={{ subject: 'I have a question regarding Gitpod Education' }} className="btn btn--cta">
              Contact Sales
            </Link>
          </td>
          <td>
    ...
    <ActionCard
      ...
      anchors={[
        ...
        { href: '/contact/', subject: 'I have a question regarding Gitpod Education', text: 'Contact' }
      ]}
    />
  </IndexLayout>
)
