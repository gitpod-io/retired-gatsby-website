...
const EducationPage: React.SFC<{}> = () => (
    <IndexLayout canonical='/education/' title="Education">
           ...
           <thead>
            ...
            <tbody>
                ...
                <tr className="buttons">
                    ...
                    <td><Link to="/contact/" state={{ subject: "Gitpod Education: sales request" }} className="btn btn--cta">Contact Sales</Link></td>
        ...
        <ActionCard
            ...
            anchors={[{href: 'https://calendly.com/gitpod/sales',text: 'Schedule a Call'}, {href: '/contact/', subject: "Gitpod Education: I have a question", text: 'Contact'}]}
        />
