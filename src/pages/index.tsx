    ...
    render() {
        ...
        return <IndexLayout canonical="https://www.gitpod.io/">
            <Page>
                ...
                <Container>
                    <SectionBuiltOn>
                        <h2>Built on open-source projects</h2>
                        <p>Gitpod is based on open-source projects which gives you a very transparent code structure</p>
                        <div className='row'>
                            <div className='col'>
                            ...
                            <div className='col'>
                                <div className='svg-container'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" style={{transform: 'scale(1.1) translateX(8px) translateY(5px)'}}>
