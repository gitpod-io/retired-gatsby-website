                ...
                <Container className="hidden-md-down">
                    <div style={{ height: 525 }} id="try">
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', marginTop: 50 }}>
                            ...
                            <ExampleBox title="Java" description='Spring-Boot Application' image={(Java)} link="https://gitpod.io/#https://github.com/gitpod-io/spring-petclinic" />
                ...
                <Container>
                    <SectionBuiltOn>
                        ...
                        <div className='row'>
                            ...
                            <div className='col'>
                                <div className='svg-container'>
                                    <a href="https://code.visualstudio.com/" target="_blank" title="VS Code" rel="noreferrer">
                                        <svg width="256" height="256" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"
                                            preserveAspectRatio="xMidYMid" role="img">
                                            <title>VS Code</title>
                            ...
                            <div className='col'>
                                <div className='svg-container'>
                                    <a href="https://golang.org/" target="_blank" title="Go" rel="noreferrer">
                            ...
                            <div className='col'>
                                <div className='svg-container'>
                                    <a href="https://www.docker.com/" target="_blank" title="Docker" rel="noreferrer">
                                        <svg className="docker" height="512" style={{ transform: 'scale(1.3) translateX(4px)' }} viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg" role="img">
                                            <title>Docker</title>
