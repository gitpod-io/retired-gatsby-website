...
const VendorPage: React.SFC<{}> = () => (
    <IndexLayout canonical='/vendor/' title="Vendor">
        ...
        >
            ...
            <tbody>
                ...
                <tr className="buttons">
                    ...
                    <td><Link to="/contact/" state={{ subject: "Gitpod Vendor: sales request" }} className="btn btn--cta">Contact Sales</Link></td>
        ...
        <ActionCard
            ...
            anchors={[{href: 'https://calendly.com/gitpod/sales',text: 'Schedule a Call'}, {href: '/contact/', subject: "Gitpod Vendor: I have a question", text: 'Contact'}]}
        />
