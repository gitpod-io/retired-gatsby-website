...
import { textCardsData } from '../utils/vendor'
...
const VendorPage: React.SFC<{}> = () => (
  <IndexLayout canonical="/vendor/" title="Vendor">
    <Banner
      ...
      title={
        <h1>
          Use <strong>Gitpod as a Showroom</strong> for
          <br /> Your Developer Products
        </h1>
      }
    ...
    <div className="grey-container">
      <TextCards title="Highlight Your Developer Products">
        {textCardsData.map((f, i) => (
          <TextCard key={i} title={f.title} paragraphs={f.paragraphs} />
        ))}
      </TextCards>
    </div>

    <Quote title="We’ll make your developer products shine." />
    ...
    >
      ...
      <tbody>
        ...
        <tr>
          <th>
            SLA <PopOver description="Custom Service Level Agreement" />
          </th>
          <td>Optional</td>
          <td>Optional</td>
          <td />
        ...
        <tr>
          <th>
            <img src={Github} alt="GitHub Logo" /> github.com
          </th>
          <td>
            <Circle />
          </td>
        ...
        <tr>
          <th>
            <img src={Github} alt="GitHub Logo" /> GitHub Enterprise
          </th>
          <td>Public only</td>
          <td>
            <Circle />
        ...
        <tr>
          <th>
            <img src={Gitlab} alt="GitLab Logo" /> gitlab.com
          </th>
          <td>
            <Circle />
          </td>
        ...
        <tr>
          <th>
            <img src={Gitlab} alt="GitLab Logo" /> GitLab Self-Managed
          </th>
          <td>Public only</td>
          <td>
            <Circle />
        ...
        <tr>
          <th>
            <img src={Bitbucket} alt="Bitbucket Logo" /> Bitbucket
          </th>
          <td>Soon</td>
          <td>Soon</td>
          <td>Soon</td>
        ...
        <tr className="buttons">
          ...
          <td>
            <Link to="/contact/" state={{ subject: 'I have a question regarding Gitpod Vendor' }} className="btn btn--cta">
              Contact Sales
            </Link>
          </td>
          <td>
            <Link to="/self-hosted/" className="btn">
              Host Yourself
            </Link>
          </td>
        </tr>
    ...
    <ActionCard
      ...
      anchors={[
        { href: 'https://calendly.com/gitpod/sales', text: 'Schedule a Call' },
        { href: '/contact/', subject: 'I have a question regarding Gitpod Vendor', text: 'Contact' }
      ]}
    />
  </IndexLayout>
)
