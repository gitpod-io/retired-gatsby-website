...
const EnterprisePage: React.SFC<{}> = () => (
  ...
  >
    ...
    <div className="grey-container">
      <TextCards title="Stay in the Flow and Scale Up Your Productivity">
        {textCardsData.map((f, i) => (
          <TextCard key={i} title={f.title} paragraphs={f.paragraphs} logos={f.logos} />
        ))}
      </TextCards>
    </div>
    ...
    <Quote title="It’s our aim to make developers’ life easier!" />
    ...
    >
      ...
      <tbody>
        ...
        <tr className="buttons">
          <th />
          <td>
            <Link to="/contact/" state={{ subject: 'I have a question regarding Gitpod Enterprise' }} className="btn btn--cta">
              Contact Sales
            </Link>
          </td>
          <td>
    ...
    <ActionCard
      ...
      anchors={[
        ...
        { href: '/contact/', subject: 'I have a question regarding Gitpod Enterprise', text: 'Contact' }
      ]}
    />
  </IndexLayout>
)
