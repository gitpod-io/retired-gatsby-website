...
export const features: FeatureCardProps[] = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="35.026" height="34.162" viewBox="0 0 35.026 34.162">
        <path
          fillRule="evenodd"
          d="M17.513 0a17.514 17.514 0 00-5.539 34.129c.876.153 1.2-.372 1.2-.832 0-.416-.022-1.8-.022-3.262-4.4.81-5.539-1.073-5.889-2.058a6.368 6.368 0 00-1.8-2.474c-.613-.328-1.489-1.138-.022-1.16a3.5 3.5 0 012.693 1.8 3.743 3.743 0 005.1 1.445 3.684 3.684 0 011.116-2.342c-3.9-.438-7.969-1.948-7.969-8.647a6.816 6.816 0 011.8-4.707 6.293 6.293 0 01.175-4.641s1.467-.46 4.816 1.8a16.511 16.511 0 018.757 0c3.349-2.277 4.816-1.8 4.816-1.8a6.293 6.293 0 01.175 4.641 6.776 6.776 0 011.8 4.707c0 6.721-4.094 8.209-7.99 8.647a4.147 4.147 0 011.182 3.24c0 2.342-.022 4.225-.022 4.816 0 .46.328 1.007 1.2.832A17.523 17.523 0 0017.513 0z"
        ></path>
      </svg>
    ),
    iconTitle: (
