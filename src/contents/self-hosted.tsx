...
export const features = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'It enables user authorization and integration via your GitHub Enterprise, GitLab, or Bitbucket.',
      'Please contact TypeFox for further customizations.'
    ],
  ...
  },
  {
    ...
    more: (
      <p className="read-more">
        Read more about <Link to="/docs/self-hosted/latest/install/oauth">GitHub and Gitlab integration</Link>.
      </p>
    )
  }
]
