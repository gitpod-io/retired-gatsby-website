...
The IDE is open-source and based on [Eclipse Theia](50-IDE.md). Theia is highly extensible and
...
Learn more about how to configure your GitHub repository [here](configuration.md).
