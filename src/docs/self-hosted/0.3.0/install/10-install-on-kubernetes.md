...
* *Google Cloud Platform*: Install Gitpod in a blank GCP project, either [using a script that automates the procedure](../11-install-on-gcp-script/) or [manually step-by-step](../12_install_on_gcp_manual/).
