...
However, Gitpod supports a range of integrations with the Google Cloud Platform (GCP) that increase performance and reliability.
This section describes the necessary steps to prepare a new GCP project for a Gitpod installation.
...
You can install Gitpod self-hosted in your GCP project from within Gitpod. This way you do not have to install the Google Cloud SDK or other required tools.
...
The [Gitpod self-hosted repository](https://github.com/gitpod-io/self-hosted) contains the configuration files this guide is referring to.
...
The script will guide you through the process. It will ask for your confirmation before doing any modifications or enabling anything that costs money.
