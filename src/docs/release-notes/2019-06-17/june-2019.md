...
See the [docs](/docs/47-environment-variables/) for more information.
...
In your `.gitpod.yml` one can now specify [port ranges](/docs/43-config-ports/#port-ranges), so you can manage antire ranges addition
