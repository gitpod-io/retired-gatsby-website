...
export const MENU: MenuEntry[] = [
  ...
  M('Gitpod Self-Hosted', 'self-hosted/latest/self-hosted', [
    ...
    M('Configure a Domain', 'self-hosted/latest/install/domain/'),
    M('Configure HTTPS Certificates', 'self-hosted/latest/install/https-certs/'),
  ...
  M('Subscriptions', 'subscriptions', [M('Professional Open Source', 'professional-open-source'), M('Create a Team', 'teams')]),
