export const features = [
    ...
    },*/
    {
        ...
        paragraphs: ['Teachers can prepare fully working and readily compiled projects, put them into a certain state and take a snapshot.', 'Students starting a workspace from that snapshot get their own clone to solve the excercise.', 'When finished, a student takes another immutable snapshot and sends it back to the teacher.']
    },
    {
        title: "Live Tutoring",
