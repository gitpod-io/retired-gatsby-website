...
export const features: FeatureCardProps[] = [
  {
    ...
    title: (
      <>
        Skip the Waiting with
        <br />
        <strong>Prebuilt Dev Environments</strong>
      </>
    ),
    text: (
      <>
  ...
  },
  {
    ...
    title: (
      <>
        Stay in the Flow
        <br />
        <strong>Integrated with GitLab, GitHub, and Bitbucket</strong>
      </>
    ),
    text: (
      <>
        ...
        <p>
          More about <a href="/docs/context-urls/">Context URLs</a>.
        </p>
      </>
    )
  },
  {
    ...
    title: (
      <>
        Code Anywhere
        <br />
        <strong>Use your Chromebook or Tablet</strong>
      </>
    ),
    text: (
      <>
