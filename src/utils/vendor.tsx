export const features = [
    ...
    },
    {
        ...
        paragraphs: ['Let Gitpod show clients what to try next with an integrated helper. You can also integrate your help system.', 'Gitpod guarantees an excellent user experience by eliminating the risk of a broken setup.']
    },
]
