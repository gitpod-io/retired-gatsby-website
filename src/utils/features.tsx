...
export const features: FeatureCardProps[] = [
  {
    ...
    text: (
      <>
        ...
        <p>
          More about <a href="/docs/vscode-extensions/">VS Code Extensions in Gitpod</a>.
        </p>
      </>
    )
  },
    ...
    text: (
      <>
        <p>
          ...
          builds to finish. Just start coding.
        </p>
        <p>
          <strong>Gitpod is the first IDE that builds your project before you even open it.</strong>
        </p>
        <p>
  ...
  },
  {
    ...
    title: (
      <>
        Stay Productive, Work
        <br />
        in <strong>Parallel Workspaces</strong>
      </>
    ),
    text: (
      <>
        ...
        <p>
          With Gitpod, you can: implement new features; merge a quick fix to a maintenance branch; troubleshoot someone's code; and do deep
          code reviews — all in self-contained browser tabs.
        </p>
      </>
    )
  },
  {
    ...
    title: (
      <>
        Just Like on Your Laptop, Including <strong>Linux Terminals</strong>
      </>
    ),
    text: (
      <>
        ...
        <p>
          More about <Link to="/docs/config-docker/">Docker Configuration</Link>.
        </p>
      </>
    )
  },
  {
    ...
    title: (
      <>
        Better Collaboration with <strong>Shared Workspaces</strong>
      </>
    ),
    text: (
      <>
        ...
        <p>
          More about <Link to="/docs/sharing-and-collaboration/">Workspace Sharing</Link>
          <div className="" />
        </p>
      </>
    )
  },
  {
    ...
    title: (
      <>
        Spread Your Work by <strong>Creating a Snapshot</strong>
      </>
    ),
    text: (
      <>
        ...
        <p>
          More about <Link to="/docs/sharing-and-collaboration/#sharing-snapshots">Sharing a Snapshot.</Link>
        </p>
      </>
    )
  },
  {
    ...
    title: (
      <>
        ...
        <br />
        For Every Task With
        <br /> <strong>Disposable Workspaces</strong>
      </>
    ),
    text: (
      <>
        <p>
          Work in up to 16 workspaces at the same time, then push your work and dispose of them when you're done. You can always get a fresh
          start.
        </p>
      </>
    )
  },
  {
    ...
    text: (
      <>
        <p>
          Open Pull/Merge Requests in Gitpod and run, navigate, or review the code from within the IDE. Reply to comments and publish code
          reviews without needing to switch tabs.
        </p>
        <p>
...
export const featuresCardsData = [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="53" height="53" viewBox="0 0 53 53" fill="#BCBCBC">
        <g>
          <path d="M39.276 0v44.981L.004 39.148l39.272 13.225 13.093-5.447V5.45L39.276 0z" />
          <path d="M25.531 7.663L13.502 19.554 6.259 14.1l-2.985 1 7.368 7.284-7.368 7.284 2.985 1 7.243-5.455 12.029 11.884 7.2-3.061v-23.31l-7.2-3.063zm0 8.485v12.464l-8.276-6.232 8.276-6.232z" />
        </g>
        <defs>
          <clipPath id="clip0">
            <path fill="#fff" d="M0 0H52.373V52.373H0z" />
          </clipPath>
        </defs>
      </svg>
    ),
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="48.5" height="39.342" viewBox="0 0 48.5 39.342">
        <g strokeLinecap="round" strokeWidth="4" data-name="Gruppe 944">
          <path d="M2 2v35.342" data-name="Linie 172" />
          <path d="M16.833 2v35.342" data-name="Linie 173" />
          <path d="M31.667 2v35.342" data-name="Linie 174" />
          <path d="M46.5 2v35.342" data-name="Linie 175" />
        </g>
      </svg>
    ),
    iconTitle: (
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="54.014" height="46.297" viewBox="0 0 54.014 46.297">
        <path d="M50.155 0H3.858A3.858 3.858 0 000 3.858v38.581A3.858 3.858 0 003.858 46.3h46.3a3.858 3.858 0 003.858-3.858V3.858A3.858 3.858 0 0050.155 0zM7.716 27.007l7.716-7.716-7.716-7.716 3.858-3.858 11.574 11.574-11.574 11.574zm30.865 3.858H23.149v-3.858h15.432z" />
      </svg>
    ),
    iconText: (
      <span>
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="49" fill="#BCBCBC" viewBox="0 0 50 49">
        <g clip-path="url(#clip0)">
          <path d="M40.953 31.664a8.43 8.43 0 00-6.126 2.636l-18.01-8.817c.138-.828.14-1.672.005-2.5l17.983-8.721a8.452 8.452 0 10-2.314-5.8c.003.413.037.826.1 1.234l-17.983 8.72a8.46 8.46 0 10-.021 11.627l18.01 8.817a8.456 8.456 0 108.357-7.2l-.001.004z" />
        </g>
        <defs>
          <clipPath id="clip0">
            <path fill="#fff" d="M0 0H49.414V48.587H0z" />
          </clipPath>
        </defs>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="54" height="42" viewBox="0 0 54 42" fill="#BCBCBC">
        <g clip-path="url(#clip0)">
          <path d="M49.15 6.555h-8.676l-5.193-5.244s-.026-.026-.039-.026l-.026-.026A4.201 4.201 0 0032.223 0h-10.8a4.251 4.251 0 00-3.162 1.4v.013l-5.077 5.141H4.319A4.268 4.268 0 000 10.822V36.8a4.323 4.323 0 004.319 4.331H49.15a4.33 4.33 0 004.319-4.331V10.822a4.275 4.275 0 00-4.319-4.267zM26.734 34.639a11.9 11.9 0 1111.876-11.9 11.912 11.912 0 01-11.876 11.9zM48.34 13.431a1.812 1.812 0 11-.024-3.624 1.812 1.812 0 01.024 3.624z" />
          <path d="M26.734 13.74a9 9 0 108.971 9 8.976 8.976 0 00-8.971-9z" />
        </g>
        <defs>
          <clipPath id="clip0">
            <path fill="#fff" d="M0 0H53.469V41.13H0z" />
          </clipPath>
        </defs>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="57" height="49" viewBox="0 0 57 49" fill="#BCBCBC">
        <g clip-path="url(#clip0)">
          <path d="M53.735 0H2.542C1.257 0 .215 1.356.215 3.028L0 33.847c0 1.673 1.042 3.028 2.327 3.028h31.431L45.768 48.4l-3.089-11.524H53.52c1.285 0 2.327-1.356 2.327-3.028l.215-30.819C56.062 1.356 55.02 0 53.735 0z" />
          <path className="white" strokeLinecap="round" strokeWidth="2" d="M47.352 11.587H9.029M47.352 18.11H9.029M47.352 24.634H9.029" />
        </g>
        <defs>
          <clipPath id="clip0">
            <path d="M0 0H56.062V48.399H0z" />
          </clipPath>
        </defs>
      </svg>
    ),
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="43.286" height="42.99" viewBox="0 0 43.286 42.99">
        <g data-name="Gruppe 691">
          <path d="M43.238 6.236V1.151A1.168 1.168 0 0042.085 0H1.153A1.168 1.168 0 000 1.151v5.085z" />
          <path
            ...
            data-name="Pfad 599"
          />
          <path d="M43.238 31.082V8.154H0v22.928l20.658 6z" data-name="andy-holmes-rCbdp8VCYhQ-unsplash" />
        </g>
      </svg>
    ),
    iconText: (
