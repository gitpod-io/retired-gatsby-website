...
export const features = [
    ...
    },
    {
        ...
        more: <p className="read-more">Read more about <Link to="/docs/self-hosted/latest/install/01-prepare-installation/#user-authorization-and-git-integration">GitHub and Gitlab integration</Link>.</p>
    }
]
