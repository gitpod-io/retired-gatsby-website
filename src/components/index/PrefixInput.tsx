      ...
      <div className="main">
        ...
        <div className="input-container">
          ...
          <span className="wrapper">
            <input defaultValue={url} onKeyPress={handleReturn} onChange={handleChange} type="text" />
            <div className="message" style={error ? { color: '#bf4338' } : {}}>
              <>
                <p>{error ? error : 'Enter your GitLab, GitHub, or Bitbucket URL'}</p>
                <a
