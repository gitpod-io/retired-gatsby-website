...
const Plans = () => (
  <Styled>
    <section id="plans">
      <h2>
        Special <strong>Use Cases</strong>
      </h2>
      <div className="links">
        <div>
          <div>
            ...
            <p>
              ...
              <a href="/docs/professional-open-source/" target="_blank">
                <strong>Professional Open Source</strong>
              </a>{' '}
              plan.
            </p>
          </div>
          <div className="btn-container">
            <Link to="/contact/" state={{ subject: 'Applying for Professional Open Source' }} className="btn">
              Apply Now
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="btn-container">
            <Link to="/contact/" state={{ subject: 'Student Unlimited: Get Verified as a Student' }} className="btn">
