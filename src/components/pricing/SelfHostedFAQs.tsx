    ...
    <div className="faqs">
      <div className="faqs__container">
        <div>
          ...
          <p>
            Of course! You can try the full version on your own infrastructure for 30 days for free. Gitpod Self-Hosted is always free for
            up to five users. Obtain your trial license{' '}
          ...
          <p>
            ...
            key. Self-hosted Gitpod licenses can currently only be purchased by request. Please <Link to="/contact/">Contact Sales</Link> to
            receive an offer.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            If you choose <strong>Gitpod Self-Hosted</strong>, you will manage and host Gitpod on your own instances. This means all data
            remains your infrastructure, as Gitpod can run behind corporate firewalls and on air-gapped networks.{' '}
            <strong>Gitpod Self-Hosted</strong> is the best solution for teams who want to keep full data control or use Gitpod in private
            networks.
          </p>
        </div>
      </div>
      <div className="faqs__container">
        ...
        <div>
          ...
          <p>
            ...
            <strong>OpenShift</strong> is coming soon. See <Link to="/docs/self-hosted/latest/self-hosted/">Self-Hosted Installation</Link>{' '}
        ...
        <div>
          <h3>How can I pay?</h3>
          <p>
            Currently, <strong>Gitpod Self-Hosted</strong> can only be purchased on request. Please <Link to="/contact">Contact Sales</Link>{' '}
            to receive an offer.
          </p>
