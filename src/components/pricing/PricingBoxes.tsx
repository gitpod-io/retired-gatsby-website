...
const plans: PricingBoxProps[] = [
  ...
  },
  {
    ...
    features: [
      'Private & Public Repos',
      <span key="50" className="span">
        8 Parallel Workspaces <PopOver description="The maximum number of workspaces a user can run at the same time" />
      </span>,
      <span key="60" className="span">
        30min Timeout <PopOver key="104" description="Workspaces without user activity are stopped after 30 minutes" />
      </span>
    ],
    btnText: 'Buy Now',
    btnBackground: true,
