      ...
      <div className="row">
        <StyledNav role="navigation" className="nav">
          <div className="nav__burger-container">
            <Link to="/">
              <img alt="Gitpod Logo" src={GitpodLogoDark} />
            </Link>
            <div className="btns">
              <a href="https://gitpod.io/login/" rel="noopener" style={{ display: isNavRendered ? 'none' : '' }}>
                Log In
              </a>
              <div className="nav__btn-container" aria-live="assertive">
                ...
                >
                  ...
                  >
                    ...
                    <g transform="translate(-647.5 -86.5)" strokeWidth="2">
                      <line x2="24" transform="translate(648.5 87.5)" />
                      <line x2="24" transform="translate(648.5 95.5)" />
                      <line x2="24" transform="translate(648.5 103.5)" />
                    </g>
                  </svg>
                </button>
              </div>
          ...
          <ul className={`nav__items ${isNavRendered ? 'navIsRendered' : 'navIsNotRendered'}`}>
            ...
            <li className="nav__item">
              <Link activeClassName="active" to="/self-hosted/" className="link">
                Self-Hosted
              </Link>
            </li>
            <li className="nav__item">
