...
const StyledPricingBox = styled.div<StyledPricingBoxProps>`
    ...
    padding: 3rem 2.8rem;
    font-size: 95%;
    min-height: ${({ isTitleOutside }) => isTitleOutside ? '35rem' : '54rem'};
    min-width: 20rem;
    max-width: 26rem;
    width: 25%;
    text-align: center;
    ...
    @media(max-width: ${sizes.breakpoints.lg}) {
        ...
        padding: 3rem 2rem;
        margin-bottom: 5rem;
        min-height: ${({ isTitleOutside }) => isTitleOutside ? '36rem' : '51rem'};
    }
    ...
    @media(max-width: ${sizes.breakpoints.md}) {
        min-height: ${({ isTitleOutside }) => isTitleOutside ? '40rem' : '48rem'};
        min-width: 30rem;
        padding: 2rem 3rem;
    }
