    ...
    <div className="row">
      <div className="links">
        <ul>
          ...
          <li>
            <Link to="/self-hosted/">Self-Hosted</Link>
          </li>
          <li>
            <a href="https://gitpod.io/login/" style={{ color: colors.link, fontWeight: 600 }}>
              Log In
            </a>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <ExternalLink href="https://github.com/gitpod-io/gitpod/issues/new?template=bug_report.md" text="Report a Bug" />
          </li>
          <li>
            <ExternalLink href="https://community.gitpod.io/" text="Community" />
          </li>
        </ul>
        <ul>
          <li>Company</li>
      ...
      <div className="info">
        <p>
          Copyright ©{' '}
          <a href="https://www.typefox.io/" target="_blank" rel="noopener" title="TypeFox">
            TypeFox
          </a>
        </p>
        <div>
          <Link to="/imprint/">Imprint</Link>&nbsp;|&nbsp;<Link to="/terms/">Terms of Service</Link>&nbsp;|&nbsp;
